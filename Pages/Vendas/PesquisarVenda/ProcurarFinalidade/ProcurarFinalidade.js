...
import styles from './ProcurarFinalidadeStyle';
import AsyncStorage from '@react-native-async-storage/async-storage';
import { Loading } from '../../../../Components/Loader'

export default function ProcurarVendaFinalidade( { navigation } ) {
    ...
    const ProcurarCodigo = async () => {
        ...
        var data = JSON.stringify({
            ...
            "sql": `select FORMAT(a.dt_lancamento, 'dd/MM/yyyy') as dt_lancamento, b.nome, a.situacao, a.c_mve, a.c_fun, a.vl_efetivo, a.finalidade from cd_mve a, cd_pessoa b where a.c_pessoa = b.c_pessoa and a.finalidade like '%${finalidade}%' and a.classe = 'V'`
        });
