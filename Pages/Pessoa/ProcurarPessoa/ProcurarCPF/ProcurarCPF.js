...
export default function ProcurarPessoaCPF( { navigation } ) {
    ...
    const ProcurarCodigo = async () => {
        ...
        var data = JSON.stringify({
            ...
            "sql": `select c_pessoa, nome, fantasia, fisica_jur, cpf, cgc, rg, FORMAT(dt_nasc, 'dd/MM/yyyy') as dt_nasc, ddd_fone, fone, ddd_celular, celular, ddd_fax, fax, insc_est, indIEDest, insc_mun, cep, bairro, endereco, numero, cidade, uf, compl, e_mail from cd_pessoa where cpf like '%${cpfSmask}%' or cpf like '%${cpfCmask}%'`
        });
